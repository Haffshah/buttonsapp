...
class _FloatingMenuState extends State<FloatingMenu>
  ...
  void initState() {
    ...
    _buttonColor =
        ColorTween(begin: Color(0xffc49b9d), end: Colors.deepOrangeAccent).animate(
      CurvedAnimation(
  ...
  Widget buttonCopy() {
    return Container(
      child: FloatingActionButton.extended(
        onPressed: () {},  backgroundColor: Color(0xffc49b9d),
        label: Text('Copy'),
  ...
  Widget buttonPaste() {
    return Container(
      child: FloatingActionButton.extended(hoverColor: Color(0xffcb8d90) ,
        backgroundColor: Color(0xffc49b9d),
        onPressed: () {},
  label:  Text('Paste'),
  ...
  Widget buttonToggle() {
    return Container(
      ...
      child: FloatingActionButton.extended(
        ...
        onPressed: animate,
        icon: !isOpened ? Icon(Icons.keyboard_arrow_down) : Icon(Icons.keyboard_arrow_up),
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
        child: Container(
          child: Text('FAB Menu Speed Dial',style: TextStyle(color: Color(0xffc49b9d)),),
        ),
      ),
    );
  }
